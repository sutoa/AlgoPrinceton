...
public class SolverTest {
    ...
    public void findsSearchNodesWithLowestPriority() throws Exception {
        ...
        pq.insert(new SearchNode(new Board(new int[]{1,0,3,4,2,5,7,8,6}), null));
        pq.insert(new SearchNode(new Board(new int[]{4,1,3,0,2,5,7,8,6}), null));
        pq.insert(new SearchNode(board3, null));

        final SearchNode expected = pq.delMin();
